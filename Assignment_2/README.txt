...
The test cases that we have provided are present in the 'Tests' folder. The expected outputs for those test cases are also present in the same folder.

The implementation details, approach, pseudocodes, function details, assumptions and limitations are included in the 'CS202_A2_Report.pdf' file.
